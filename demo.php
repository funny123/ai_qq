...
// $response = API::wxface_pitu($params);
// // file_put_contents('12.txt', $response.data['image']);
// $arr = json_decode($response,1);
// // file_put_contents('333.txt', $arr['data']['image']);
// file_put_contents('demo.jpg', base64_decode($arr['data']['image']));
// exit($arr['data']['image']);
// exit($response);
